    ...
    return (
        <Flex sx={flex}>
            <HStack display={{base: "none",sm: "none", md: "none", lg: "flex"}}>
                {/* to be replaced by component */}
                <Image src="logo.png" style={{width: "40px"}} /> 
                <Box sx={vr}></Box>
                <Button variant="ghost"><Link to="dashboard">Начало</Link></Button>
            ...
            >
                ...
                >
                    <Flex flexDir="column">
                        <Button variant="ghost" mb="5px"><Link to="dashboard">Начало</Link></Button>
                        <Button variant="ghost" mb="5px">Куестове</Button>
                        <Button variant="ghost" mb="5px">Събития</Button>
                        <Button variant="ghost" mb="5px">Как да стигна?</Button>
                        <Button variant="ghost" mb="5px">Забавни спомени</Button>
                        <Button variant="ghost" mb="5px">Полезно</Button>
                        <Button variant="ghost" mb="5px">Настройки</Button>
                    </Flex>
            ...
            <Heading fontSize="18px" display={{sm: "flex", md: "flex", lg: "none"}}>Начало</Heading>

            <HStack>
                <AvatarGroup spacing="1em">
                    <Avatar bg="none"  border="none" icon={<BellIcon boxSize="6"/>}>
                        <AvatarBadge boxSize="1em" bg="#44818B" borderColor="#44818B">
